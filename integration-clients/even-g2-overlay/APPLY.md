...
Its paths are relative to a compatible Even Hub G2 client project:
...
- `scripts/package-openagi.mjs` generates an Even Hub manifest and
...
there. To package the generic client with host selection at runtime:
